<h2><a href="https://leetcode.com/problems/two-sum/submissions/2139358604/">1. Two Sum</a></h2><h3>Difficulty: Easy</h3><hr><p>You are given an array of integers `nums`&nbsp;and an integer `target`, return <em>indices of the two numbers such that they add up to `target`</em>.</p>
